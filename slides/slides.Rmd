---
title: "Data visualisation in RStudio using the package `ggplot2`"
author: "Jens Roeser"
output: 
...
- Download: [https://github.com/jensroes/](https://github.com/jensroes/edge-hill-r-workshop)
- Click on: `Code` \> `Download ZIP` \> unzip directory on your machine.
- Open project by double clicking on `edge-hill-r-workshop.Rproj`
